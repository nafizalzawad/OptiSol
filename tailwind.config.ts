...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 12px 30px -20px hsl(var(--brand-blue) / 0.35)",
        glow: "0 0 0 1px hsl(var(--brand-yellow) / 0.35), 0 18px 40px -24px hsl(var(--brand-blue) / 0.45)",
      },
      backgroundImage: {
      ...
      animation: {
        ...
        "enter": "fade-in 0.5s ease-out, scale-in 0.35s ease-out",
